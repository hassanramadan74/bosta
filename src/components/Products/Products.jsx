...
const BlogItem = ({ item }) => {
  ...
  const formattedId = new Intl.NumberFormat(i18n.language === "ar" ? "ar-EG" : "en-US").format(item.id);
  const fontClass = i18n.language === "ar" ? "font-cairo" : "font-primary";
  return (
    <div className={`rounded-lg overflow-hidden mt-6 lg:mt-0 ${fontClass}`} dir={direction}>
